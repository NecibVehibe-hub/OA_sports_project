...
function Card({title,paragraph}){
    return(
        <div className="w-full  3xl:mb-20 3xl:w-95  3xl:h-53">
...
function WhyOASports(){
    ...
    return(
        <div className="3xl:flex 3xl:justify-center 3xl:w-345">
            <div className="w-full py-6 px-4  flex flex-col gap-4 bg-bg 3xl:py-12 3xl:px-12 3xl:gap-10  3xl:max-h-195">
                    <Title start={t("WhyOASports.Why")} center={t("WhyOASports.OA_sports")}/> 
                    <div className="3xl:w-312 3xl:gap-7 flex flex-col md:grid md:grid-cols-2  3xl:overflow-hidden md:gap-y-14 gap-5 3xl:grid-cols-3">
