...
function WhyOASports(){
    ...
    return(
        <div className="w-full h-175 md:max-h-120.5 py-6 px-4 flex flex-col gap-4 bg-bg 3xl:py-12 3xl:px-24 3xl:gap-10 3xl:max-h-188.5">
            <Title start={t("WhyOASports.Why")} center={t("WhyOASports.OA_sports")}  />
            <div className="h-253 w-full flex flex-col md:grid md:grid-cols-2 md:h-16 gap-14 3xl:gap-30 3xl:grid-cols-3">
