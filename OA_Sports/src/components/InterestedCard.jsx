...
function InterestedCard(){
    ...
    return(
        <div className="w-full 3xl:flex py-6 px-4 3xl:justify-center 3xl:h-120 3xl:py-12 3xl:px-24">
            <div className="w-full 3xl:w-312 relative h-full flex items-center  rounded-3xl xl:h-98">
